...
<template v-else-if="(name === 'academic-cap' || name === 'AcademicCapIcon') && (outlined !== undefined && outlined !== false)">
...
<template v-else-if="(name === 'adjustments-horizontal' || name === 'AdjustmentsHorizontalIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'adjustments-vertical' || name === 'AdjustmentsVerticalIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'archive-box-arrow-down' || name === 'ArchiveBoxArrowDownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'archive-box-x-mark' || name === 'ArchiveBoxXMarkIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'archive-box' || name === 'ArchiveBoxIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-down-circle' || name === 'ArrowDownCircleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-down-left' || name === 'ArrowDownLeftIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-down-on-square-stack' || name === 'ArrowDownOnSquareStackIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-down-on-square' || name === 'ArrowDownOnSquareIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-down-right' || name === 'ArrowDownRightIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-down-tray' || name === 'ArrowDownTrayIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-down' || name === 'ArrowDownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-left-circle' || name === 'ArrowLeftCircleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-left-end-on-rectangle' || name === 'ArrowLeftEndOnRectangleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-left-on-rectangle' || name === 'ArrowLeftOnRectangleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
  <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15M12 9l-3 3m0 0 3 3m-3-3h12.75"/>
</svg>
...
<template v-else-if="(name === 'arrow-left-start-on-rectangle' || name === 'ArrowLeftStartOnRectangleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-left' || name === 'ArrowLeftIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-long-down' || name === 'ArrowLongDownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-long-left' || name === 'ArrowLongLeftIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-long-right' || name === 'ArrowLongRightIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-long-up' || name === 'ArrowLongUpIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-path-rounded-square' || name === 'ArrowPathRoundedSquareIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-path' || name === 'ArrowPathIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-right-circle' || name === 'ArrowRightCircleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-right-end-on-rectangle' || name === 'ArrowRightEndOnRectangleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-right-on-rectangle' || name === 'ArrowRightOnRectangleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-right-start-on-rectangle' || name === 'ArrowRightStartOnRectangleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
  <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15m3 0 3-3m0 0-3-3m3 3H9"/>
</svg>
...
<template v-else-if="(name === 'arrow-right' || name === 'ArrowRightIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-small-down' || name === 'ArrowSmallDownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-small-left' || name === 'ArrowSmallLeftIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-small-right' || name === 'ArrowSmallRightIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-small-up' || name === 'ArrowSmallUpIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-top-right-on-square' || name === 'ArrowTopRightOnSquareIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-trending-down' || name === 'ArrowTrendingDownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-trending-up' || name === 'ArrowTrendingUpIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-turn-down-left' || name === 'ArrowTurnDownLeftIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-turn-down-right' || name === 'ArrowTurnDownRightIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-turn-left-down' || name === 'ArrowTurnLeftDownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-turn-left-up' || name === 'ArrowTurnLeftUpIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-turn-right-down' || name === 'ArrowTurnRightDownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-turn-right-up' || name === 'ArrowTurnRightUpIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-turn-up-left' || name === 'ArrowTurnUpLeftIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-turn-up-right' || name === 'ArrowTurnUpRightIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-up-circle' || name === 'ArrowUpCircleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-up-left' || name === 'ArrowUpLeftIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-up-on-square-stack' || name === 'ArrowUpOnSquareStackIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-up-on-square' || name === 'ArrowUpOnSquareIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-up-right' || name === 'ArrowUpRightIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-up-tray' || name === 'ArrowUpTrayIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-up' || name === 'ArrowUpIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-uturn-down' || name === 'ArrowUturnDownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-uturn-left' || name === 'ArrowUturnLeftIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-uturn-right' || name === 'ArrowUturnRightIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrow-uturn-up' || name === 'ArrowUturnUpIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrows-pointing-in' || name === 'ArrowsPointingInIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrows-pointing-out' || name === 'ArrowsPointingOutIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrows-right-left' || name === 'ArrowsRightLeftIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'arrows-up-down' || name === 'ArrowsUpDownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'at-symbol' || name === 'AtSymbolIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'backspace' || name === 'BackspaceIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'backward' || name === 'BackwardIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'banknotes' || name === 'BanknotesIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bars-2' || name === 'Bars2Icon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bars-3-bottom-left' || name === 'Bars3BottomLeftIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bars-3-bottom-right' || name === 'Bars3BottomRightIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bars-3-center-left' || name === 'Bars3CenterLeftIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bars-3' || name === 'Bars3Icon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bars-4' || name === 'Bars4Icon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bars-arrow-down' || name === 'BarsArrowDownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bars-arrow-up' || name === 'BarsArrowUpIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'battery-0' || name === 'Battery0Icon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'battery-100' || name === 'Battery100Icon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'battery-50' || name === 'Battery50Icon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'beaker' || name === 'BeakerIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bell-alert' || name === 'BellAlertIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bell-slash' || name === 'BellSlashIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bell-snooze' || name === 'BellSnoozeIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bell' || name === 'BellIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bold' || name === 'BoldIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bolt-slash' || name === 'BoltSlashIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bolt' || name === 'BoltIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'book-open' || name === 'BookOpenIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bookmark-slash' || name === 'BookmarkSlashIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bookmark-square' || name === 'BookmarkSquareIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bookmark' || name === 'BookmarkIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'briefcase' || name === 'BriefcaseIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'bug-ant' || name === 'BugAntIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'building-library' || name === 'BuildingLibraryIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'building-office-2' || name === 'BuildingOffice2Icon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'building-office' || name === 'BuildingOfficeIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'building-storefront' || name === 'BuildingStorefrontIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'cake' || name === 'CakeIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'calculator' || name === 'CalculatorIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'calendar-date-range' || name === 'CalendarDateRangeIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'calendar-days' || name === 'CalendarDaysIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'calendar' || name === 'CalendarIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'camera' || name === 'CameraIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chart-bar-square' || name === 'ChartBarSquareIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chart-bar' || name === 'ChartBarIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chart-pie' || name === 'ChartPieIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chat-bubble-bottom-center-text' || name === 'ChatBubbleBottomCenterTextIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chat-bubble-bottom-center' || name === 'ChatBubbleBottomCenterIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chat-bubble-left-ellipsis' || name === 'ChatBubbleLeftEllipsisIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chat-bubble-left-right' || name === 'ChatBubbleLeftRightIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chat-bubble-left' || name === 'ChatBubbleLeftIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chat-bubble-oval-left-ellipsis' || name === 'ChatBubbleOvalLeftEllipsisIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chat-bubble-oval-left' || name === 'ChatBubbleOvalLeftIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'check-badge' || name === 'CheckBadgeIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'check-circle' || name === 'CheckCircleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'check' || name === 'CheckIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chevron-double-down' || name === 'ChevronDoubleDownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chevron-double-left' || name === 'ChevronDoubleLeftIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chevron-double-right' || name === 'ChevronDoubleRightIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chevron-double-up' || name === 'ChevronDoubleUpIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chevron-down' || name === 'ChevronDownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chevron-left' || name === 'ChevronLeftIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chevron-right' || name === 'ChevronRightIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chevron-up-down' || name === 'ChevronUpDownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'chevron-up' || name === 'ChevronUpIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'circle-stack' || name === 'CircleStackIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'clipboard-document-check' || name === 'ClipboardDocumentCheckIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'clipboard-document-list' || name === 'ClipboardDocumentListIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'clipboard-document' || name === 'ClipboardDocumentIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'clipboard' || name === 'ClipboardIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'clock' || name === 'ClockIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'cloud-arrow-down' || name === 'CloudArrowDownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'cloud-arrow-up' || name === 'CloudArrowUpIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'cloud' || name === 'CloudIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'code-bracket-square' || name === 'CodeBracketSquareIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'code-bracket' || name === 'CodeBracketIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'cog-6-tooth' || name === 'Cog6ToothIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'cog-8-tooth' || name === 'Cog8ToothIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'cog' || name === 'CogIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'command-line' || name === 'CommandLineIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'computer-desktop' || name === 'ComputerDesktopIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'cpu-chip' || name === 'CpuChipIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'credit-card' || name === 'CreditCardIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'cube-transparent' || name === 'CubeTransparentIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'cube' || name === 'CubeIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'currency-bangladeshi' || name === 'CurrencyBangladeshiIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'currency-dollar' || name === 'CurrencyDollarIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'currency-euro' || name === 'CurrencyEuroIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'currency-pound' || name === 'CurrencyPoundIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'currency-rupee' || name === 'CurrencyRupeeIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'currency-yen' || name === 'CurrencyYenIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'cursor-arrow-rays' || name === 'CursorArrowRaysIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'cursor-arrow-ripple' || name === 'CursorArrowRippleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'device-phone-mobile' || name === 'DevicePhoneMobileIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'device-tablet' || name === 'DeviceTabletIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'divide' || name === 'DivideIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'document-arrow-down' || name === 'DocumentArrowDownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'document-arrow-up' || name === 'DocumentArrowUpIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'document-chart-bar' || name === 'DocumentChartBarIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'document-check' || name === 'DocumentCheckIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'document-currency-bangladeshi' || name === 'DocumentCurrencyBangladeshiIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'document-currency-dollar' || name === 'DocumentCurrencyDollarIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'document-currency-euro' || name === 'DocumentCurrencyEuroIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'document-currency-pound' || name === 'DocumentCurrencyPoundIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'document-currency-rupee' || name === 'DocumentCurrencyRupeeIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'document-currency-yen' || name === 'DocumentCurrencyYenIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'document-duplicate' || name === 'DocumentDuplicateIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'document-magnifying-glass' || name === 'DocumentMagnifyingGlassIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'document-minus' || name === 'DocumentMinusIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'document-plus' || name === 'DocumentPlusIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'document-text' || name === 'DocumentTextIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'document' || name === 'DocumentIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'ellipsis-horizontal-circle' || name === 'EllipsisHorizontalCircleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'ellipsis-horizontal' || name === 'EllipsisHorizontalIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'ellipsis-vertical' || name === 'EllipsisVerticalIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'envelope-open' || name === 'EnvelopeOpenIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'envelope' || name === 'EnvelopeIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'equals' || name === 'EqualsIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'exclamation-circle' || name === 'ExclamationCircleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'exclamation-triangle' || name === 'ExclamationTriangleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'eye-dropper' || name === 'EyeDropperIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'eye-slash' || name === 'EyeSlashIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'eye' || name === 'EyeIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'face-frown' || name === 'FaceFrownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'face-smile' || name === 'FaceSmileIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'film' || name === 'FilmIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'finger-print' || name === 'FingerPrintIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'fire' || name === 'FireIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'flag' || name === 'FlagIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'folder-arrow-down' || name === 'FolderArrowDownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'folder-minus' || name === 'FolderMinusIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'folder-open' || name === 'FolderOpenIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'folder-plus' || name === 'FolderPlusIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'folder' || name === 'FolderIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'forward' || name === 'ForwardIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'funnel' || name === 'FunnelIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'gif' || name === 'GifIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'gift-top' || name === 'GiftTopIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'gift' || name === 'GiftIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'globe-alt' || name === 'GlobeAltIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'globe-americas' || name === 'GlobeAmericasIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'globe-asia-australia' || name === 'GlobeAsiaAustraliaIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'globe-europe-africa' || name === 'GlobeEuropeAfricaIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'h1' || name === 'H1Icon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'h2' || name === 'H2Icon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'h3' || name === 'H3Icon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'hand-raised' || name === 'HandRaisedIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'hand-thumb-down' || name === 'HandThumbDownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'hand-thumb-up' || name === 'HandThumbUpIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'hashtag' || name === 'HashtagIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'heart' || name === 'HeartIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'home-modern' || name === 'HomeModernIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'home' || name === 'HomeIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'identification' || name === 'IdentificationIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'inbox-arrow-down' || name === 'InboxArrowDownIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'inbox-stack' || name === 'InboxStackIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'inbox' || name === 'InboxIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'information-circle' || name === 'InformationCircleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'italic' || name === 'ItalicIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'key' || name === 'KeyIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'language' || name === 'LanguageIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'lifebuoy' || name === 'LifebuoyIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'light-bulb' || name === 'LightBulbIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'link-slash' || name === 'LinkSlashIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'link' || name === 'LinkIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'list-bullet' || name === 'ListBulletIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'lock-closed' || name === 'LockClosedIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'lock-open' || name === 'LockOpenIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'magnifying-glass-circle' || name === 'MagnifyingGlassCircleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'magnifying-glass-minus' || name === 'MagnifyingGlassMinusIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'magnifying-glass-plus' || name === 'MagnifyingGlassPlusIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'magnifying-glass' || name === 'MagnifyingGlassIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'map-pin' || name === 'MapPinIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'map' || name === 'MapIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'megaphone' || name === 'MegaphoneIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'microphone' || name === 'MicrophoneIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'minus-circle' || name === 'MinusCircleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'minus-small' || name === 'MinusSmallIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'minus' || name === 'MinusIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'moon' || name === 'MoonIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'musical-note' || name === 'MusicalNoteIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'newspaper' || name === 'NewspaperIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'no-symbol' || name === 'NoSymbolIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'numbered-list' || name === 'NumberedListIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'paint-brush' || name === 'PaintBrushIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'paper-airplane' || name === 'PaperAirplaneIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'paper-clip' || name === 'PaperClipIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'pause-circle' || name === 'PauseCircleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'pause' || name === 'PauseIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'pencil-square' || name === 'PencilSquareIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'pencil' || name === 'PencilIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'percent-badge' || name === 'PercentBadgeIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'phone-arrow-down-left' || name === 'PhoneArrowDownLeftIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'phone-arrow-up-right' || name === 'PhoneArrowUpRightIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'phone-x-mark' || name === 'PhoneXMarkIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'phone' || name === 'PhoneIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'photo' || name === 'PhotoIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'play-circle' || name === 'PlayCircleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'play-pause' || name === 'PlayPauseIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'play' || name === 'PlayIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'plus-circle' || name === 'PlusCircleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'plus-small' || name === 'PlusSmallIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'plus' || name === 'PlusIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'power' || name === 'PowerIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'presentation-chart-bar' || name === 'PresentationChartBarIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'presentation-chart-line' || name === 'PresentationChartLineIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'printer' || name === 'PrinterIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'puzzle-piece' || name === 'PuzzlePieceIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'qr-code' || name === 'QrCodeIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'question-mark-circle' || name === 'QuestionMarkCircleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'queue-list' || name === 'QueueListIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'radio' || name === 'RadioIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'receipt-percent' || name === 'ReceiptPercentIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'receipt-refund' || name === 'ReceiptRefundIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'rectangle-group' || name === 'RectangleGroupIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'rectangle-stack' || name === 'RectangleStackIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'rocket-launch' || name === 'RocketLaunchIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'rss' || name === 'RssIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'scale' || name === 'ScaleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'scissors' || name === 'ScissorsIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'server-stack' || name === 'ServerStackIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'server' || name === 'ServerIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'share' || name === 'ShareIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'shield-check' || name === 'ShieldCheckIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'shield-exclamation' || name === 'ShieldExclamationIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'shopping-bag' || name === 'ShoppingBagIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'shopping-cart' || name === 'ShoppingCartIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'signal-slash' || name === 'SignalSlashIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'signal' || name === 'SignalIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'slash' || name === 'SlashIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'sparkles' || name === 'SparklesIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'speaker-wave' || name === 'SpeakerWaveIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'speaker-x-mark' || name === 'SpeakerXMarkIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'square-2-stack' || name === 'Square2StackIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'square-3-stack-3d' || name === 'Square3Stack3dIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'squares-2x2' || name === 'Squares2x2Icon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'squares-plus' || name === 'SquaresPlusIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'star' || name === 'StarIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'stop-circle' || name === 'StopCircleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
  <path stroke-linecap="round" stroke-linejoin="round" d="M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
...
<template v-else-if="(name === 'stop' || name === 'StopIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'strikethrough' || name === 'StrikethroughIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'sun' || name === 'SunIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'swatch' || name === 'SwatchIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'table-cells' || name === 'TableCellsIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'tag' || name === 'TagIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'ticket' || name === 'TicketIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'trash' || name === 'TrashIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'trophy' || name === 'TrophyIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'truck' || name === 'TruckIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'tv' || name === 'TvIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'underline' || name === 'UnderlineIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'user-circle' || name === 'UserCircleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'user-group' || name === 'UserGroupIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'user-minus' || name === 'UserMinusIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'user-plus' || name === 'UserPlusIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'user' || name === 'UserIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'users' || name === 'UsersIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'variable' || name === 'VariableIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'video-camera-slash' || name === 'VideoCameraSlashIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'video-camera' || name === 'VideoCameraIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'view-columns' || name === 'ViewColumnsIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'viewfinder-circle' || name === 'ViewfinderCircleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'wallet' || name === 'WalletIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'wifi' || name === 'WifiIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'window' || name === 'WindowIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'wrench-screwdriver' || name === 'WrenchScrewdriverIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'wrench' || name === 'WrenchIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'x-circle' || name === 'XCircleIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
...
<template v-else-if="(name === 'x-mark' || name === 'XMarkIcon') && (outlined !== undefined && outlined !== false)">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
